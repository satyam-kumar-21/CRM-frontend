...
export default function CompanyAdminDashboardPage() {
  ...
  return <ProtectedRoute roles={['COMPANY_ADMIN']}><div className="h-screen overflow-hidden bg-slate-950 text-slate-100 font-sans antialiased"><div className="grid h-screen grid-cols-1 lg:grid-cols-[280px_1fr] lg:min-h-0"><CompanyAdminSidebar companyName={dashboard?.company?.name} navigationMenu={navigationMenu} activeSection={activeSection} setActiveSection={setActiveSection} /><main className="flex min-h-0 flex-col overflow-hidden bg-slate-950">
