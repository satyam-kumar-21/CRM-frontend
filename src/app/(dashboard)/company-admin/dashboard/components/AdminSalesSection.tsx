              ...
              <div className="flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
                <div className="flex-1 space-y-2">
                  <div className="flex items-center flex-wrap gap-2">
                    ...
                    {sale.transactionType === 'UPGRADE' && <span className="rounded-full border border-fuchsia-500/30 bg-fuchsia-500/10 px-2 py-0.5 text-[10px] font-semibold text-fuchsia-300">Upgrade</span>}
                  ...
                  <div className="grid gap-2 text-[11px] text-slate-400">
                    ...
                    {sale.salesEmployeeRemark && <div className="rounded-lg border border-cyan-500/20 bg-cyan-500/5 p-2 text-cyan-100"><span className="font-semibold text-cyan-300">Upgrade message:</span> {sale.salesEmployeeRemark}</div>}
                  </div>
                </div>
              ...
              <div className="flex flex-col gap-2 md:flex-row md:items-start md:justify-between">
                <div className="flex-1 space-y-1">
                  ...
                  <div className="grid gap-1 text-[10px] text-slate-400">
                    ...
                    {sale.salesEmployeeRemark && <div className="text-cyan-300">Upgrade message: {sale.salesEmployeeRemark}</div>}
                  </div>
                </div>
              </div>
            </div>
