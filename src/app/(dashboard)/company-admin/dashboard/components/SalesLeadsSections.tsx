...
export function LeadsSection({ readOnly = false }: { readOnly?: boolean }) {
  ...
  const exportLeads = () => downloadCsv('leads.csv', [['Lead', 'Country', 'System', 'Contact', 'Connected By', 'Connected', 'Sale'], ...filteredLeads.map((lead) => [lead.name, lead.country, lead.system, readOnly ? maskSensitiveValue(lead.contactNo) : lead.contactNo, lead.connectedBy, lead.connected, lead.isSale])]);
