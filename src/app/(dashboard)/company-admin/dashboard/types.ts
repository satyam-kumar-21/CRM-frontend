export type NavSection = 'overview' | 'chat' | 'employees' | 'groups' | 'sales' | 'failed-sales' | 'leads' | 'attendance' | 'salary' | 'leave' | 'announcements' | 'projects' | 'remote-support' | 'todays-report' | 'billing' | 'settings' | 'profile';
